...
class Event(models.Model):
    ...
    Event log model.
    """
    type = models.CharField(('Event Type'), max_length=50)
    group = models.UUIDField(('Event Group'))
    timestamp = models.DateTimeField(('Timestamp'), auto_now_add=True)
    message = models.CharField(('Message'), max_length=500)
    initiator = models.CharField(('Initiator'), max_length=500, blank=True, null=True)
